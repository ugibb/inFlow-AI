...
import {
  LayoutDashboard, BookOpen, GitGraph,
  Settings, X, Sun, Moon, Menu, Sparkles,
  Users, LogOut, Plug
} from 'lucide-react';
...
const adminNavItems = [
  ...
  { href: '/plugins', label: '插件管理', icon: Plug },
    ...
    <>
      ...
      <div className="h-16 flex items-center px-4 border-b border-[var(--border-color)]">
        <div className="flex items-center gap-3">
          ...
          {!collapsed && (
            <span className="font-bold text-lg text-[var(--text-primary)] whitespace-nowrap">inFlow AI</span>
          )}
        </div>
    ...
    <>
      ...
      <div className="md:hidden fixed top-0 left-0 right-0 z-40 h-14 bg-[var(--bg-primary)] border-b border-[var(--border-color)] flex items-center px-4">
        ...
        <div className="flex items-center gap-2 ml-2">
          ...
          <span className="font-bold text-base text-[var(--text-primary)]">inFlow AI</span>
        </div>
