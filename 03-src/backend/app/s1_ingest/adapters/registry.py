...
class AdapterRegistry:
    ...
    def _build(self) -> None:
        ...
        from app.s1_ingest.adapters.wechat import WechatAdapter
        from app.s1_ingest.adapters.bilibili import BilibiliAdapter
        from app.s1_ingest.adapters.xiaoyuzhou import XiaoyuzhouAdapter
        from app.s1_ingest.adapters.xhs import XhsAdapter
        from app.s1_ingest.adapters.douyin import DouyinAdapter
        from app.s1_ingest.adapters.youtube import YoutubeAdapter
        from app.s1_ingest.adapters.toutiao import ToutiaoAdapter
        from app.s1_ingest.adapters.juejin import JuejinAdapter
        from app.s1_ingest.adapters.csdn import CsdnAdapter
        from app.s1_ingest.adapters.feishu import FeishuAdapter
        from app.s1_ingest.adapters.generic import GenericAdapter
