...
from app.core.models.article import Article, Tag, Folder, ArticleStatus, KnowledgeEdge, article_tags
...
from app.s1_ingest.fetchers import parser_service, extract_url_from_text
from app.s1_ingest.orchestrator import ingest_url, ingest_upload, ingest_text
from app.core.shared.ai_service import llm_service
from app.s3_display.services.graph_service import graph_service
from app.s3_display.services.spark_service import generate_article
...
async def _maybe_push_proactive_relation(db, article_id):
    ...
    import httpx
    from app.extensions.review.service import send_wechat
...
async def get_article_chapters(
    ...
    from app.core.shared.storage.conventions import parse_chapters_path
    ...
    if not data.get("total_duration"):
        try:
            from app.core.shared.storage.conventions import parse_transcript_base
...
async def get_article_deep_read(
    ...
    from pathlib import Path
    from app.core.shared.storage.conventions import display_card_html_path
...
async def capture_article_deep_read_screenshot(
    ...
    from app.s4_compose.card_renderer import screenshot_html_content
...
async def get_article_regen_status(
    ...
    from app.core.shared.progress import get_progress
