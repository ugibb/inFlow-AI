...
from backend.core.dependencies import get_current_user, create_long_lived_token
from backend.core.models import Article, KnowledgeEdge, User
...
async def push_article(
    ...
    """
    from backend.core.models.article import Folder
