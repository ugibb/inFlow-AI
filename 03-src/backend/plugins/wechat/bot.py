...
parser_service):
    ...
    python -m backend.plugins.wechat.bot
...
from backend.core.models import User, WechatAccount
from backend.core.utils.logger import configure_third_party_loggers, get_logger, setup_logging
...
class AccountWorker:
    ...
    async def _touch_context_token(self, sender: str, ctx: str) -> None:
        ...
        from backend.core.models.wechat_callback import WechatCallbackQueue
    ...
    async def _handle(self, client: httpx.AsyncClient, acct: WechatAccount, msg: dict):
        ...
        if url:
            ...
            if ok and job_id:
                ...
                from backend.core.pipeline.pipeline_log import log_wechat_url_submitted
    ...
    async def _send_image(
        ...
        *,
        ...
        from backend.plugins.wechat.ilink_media import upload_image_item
        ...
        if sent and job_id and push_label:
            from backend.core.pipeline.pipeline_log import log_job_event
    ...
    async def _process_ready_callbacks(self, img_client: httpx.AsyncClient) -> None:
        ...
        for row in rows:
            ...
            from backend.core.pipeline.pipeline_log import log_job_event, resolve_phase_label, resolve_phase_task_name
