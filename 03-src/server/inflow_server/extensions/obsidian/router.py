...
from inflow_core.core.dependencies import get_current_user, create_long_lived_token
from inflow_core.core.models import Article, KnowledgeEdge, User
...
async def push_article(
    ...
    """
    from inflow_core.core.models.article import Folder
