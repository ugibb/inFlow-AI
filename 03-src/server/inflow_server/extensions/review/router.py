...
from inflow_core.core.models import ReviewSchedule, User, WechatAccount
from inflow_server.extensions.review.service import compute_next_send_at, generate_review_text
...
async def preview_review(
    ...
    from inflow_core.core.models import Article
