...
class TemplateRegistry:
    ...
    def _build(self) -> None:
        ...
        from inflow_core.parse.templates.wechat_article import WechatArticleTemplate
        from inflow_core.parse.templates.bilibili_video import BilibiliVideoTemplate
        from inflow_core.parse.templates.xiaoyuzhou_podcast import XiaoyuzhouPodcastTemplate
        from inflow_core.parse.templates.xhs_note import XhsNoteTemplate
        from inflow_core.parse.templates.document import DocumentTemplate
        from inflow_core.parse.templates.generic import GenericTemplate
