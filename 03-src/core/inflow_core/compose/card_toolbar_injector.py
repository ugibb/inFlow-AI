...
Usage
-----
from inflow_core.compose.card_toolbar_injector import CardToolbarInjector
...
from inflow_core.prompts import PROMPTS_DIR

# Location of the 30-theme manifest (produced by extract_themes.py)
_THEMES_JSON = PROMPTS_DIR / "s4/card_themes_mapped.json"
