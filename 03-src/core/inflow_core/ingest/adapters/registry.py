...
class AdapterRegistry:
    ...
    def _build(self) -> None:
        ...
        from inflow_core.ingest.adapters.wechat import WechatAdapter
        from inflow_core.ingest.adapters.bilibili import BilibiliAdapter
        from inflow_core.ingest.adapters.xiaoyuzhou import XiaoyuzhouAdapter
        from inflow_core.ingest.adapters.xhs import XhsAdapter
        from inflow_core.ingest.adapters.douyin import DouyinAdapter
        from inflow_core.ingest.adapters.youtube import YoutubeAdapter
        from inflow_core.ingest.adapters.toutiao import ToutiaoAdapter
        from inflow_core.ingest.adapters.juejin import JuejinAdapter
        from inflow_core.ingest.adapters.csdn import CsdnAdapter
        from inflow_core.ingest.adapters.feishu import FeishuAdapter
        from inflow_core.ingest.adapters.generic import GenericAdapter
